    ...
    <div class="H" >
            ...
            <div class="in-container" >
                ...
                <div class="profile-card">
                    <div>
                        <img src="Images-Profile-Professor/<?= $pf_Img ?>.jpg">
                    </div>

                    <div class="profile-info">
                        <div>
                            <h2><?= $Name ?></h2>
                            <a href="coordinator_edit_profile.php" class="edit-link">แก้ไขข้อมูลส่วนตัว</a>
                        </div>
                        <div class="in-info">
                            <p>Email address</p>
                            <p><?= $pf_Email ?></p>
                ...
                <!-- Information List -->
                <div class="info-list">
                    <div class="fix-text" style="font-size: 16px;">
                        <div><p>ชื่อ:</p></div>
                        <div><p>สกุล:</p></div>
                        <div><p>สาขา:</p></div>
                        <div><p>ตำแหน่ง:</p></div>
