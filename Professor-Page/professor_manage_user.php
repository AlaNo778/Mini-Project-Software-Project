        ...
        if ($stmt->num_rows > 0) {
            ...
            if ($current_password == $db_password) { // ตรวจสอบรหัสผ่านเดิม
                ...
                if ($update_stmt->execute()) {
                    echo "<script>alert('เปลี่ยนรหัสผ่านสำเร็จ!'); window.location='coordinator_dashboard.php';</script>";
                } else {
...
<body>
    ...
    <div class="container">
        ...
        <form method="POST" onsubmit="return validatePassword()">
            ...
            <button type="button" class="btn btn-danger" onclick="window.location.href='coordinator_dashboard.php'">
