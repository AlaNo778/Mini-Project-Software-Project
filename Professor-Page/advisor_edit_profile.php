...
<body>
    ...
    <div class="H">
            ...
            <form method="POST" enctype="multipart/form-data" action="advisor_edit_profile.php">
                            ...
                            <div class="button-group">
                                <?php if (!$editable): ?>
                                    <button class="b-red"><a href="advisor_profile.php" class="cancel-button">❌ ยกเลิก</a></button>
                                    <button class="b-blue" type="submit" name="edit">✏️แก้ไข </button>
